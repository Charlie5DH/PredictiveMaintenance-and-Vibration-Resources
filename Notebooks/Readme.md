...
The `utils.py` file has some functions to extract features from vibration, however these were not made by me, i copied the functions there to analyze them later and see if they are usefull.
